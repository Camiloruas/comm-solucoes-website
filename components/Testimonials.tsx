...
const Testimonials: React.FC = () => {
  return (
    <section id="depoimentos" className="py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="space-y-4">
            <h2 className="text-sm font-bold tracking-[0.3em] uppercase text-gray-400">O que dizem</h2>
            <p className="text-4xl md:text-5xl font-black text-black dark:text-white">DEPOIMENTOS</p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {testimonials.map((t) => (
            <div key={t.id} className="relative bg-gray-50 dark:bg-gray-800 p-10 rounded-3xl border border-gray-100 dark:border-gray-700 text-center flex flex-col items-center lg:items-start lg:text-left">
              ...
              <p className="text-lg text-gray-700 dark:text-gray-300 italic mb-8 leading-relaxed">"{t.text}"</p>
              <div>
