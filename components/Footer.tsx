    ...
    <footer className="bg-black dark:bg-black text-white pt-20 pb-10 border-t border-transparent dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <p className="text-gray-400 font-light mb-4">
              Receba dicas de decoração e novas tendências.
            </p>
            <div className="flex">
              <input
                type="email"
                placeholder="Seu e-mail"
                className="bg-gray-900 border-none rounded-l-xl px-4 py-3 flex-1 focus:ring-1 focus:ring-emerald-500"
              />
              <button className="bg-emerald-500 text-white px-4 py-3 rounded-r-xl font-bold">
                OK
              </button>
            </div>
          </div>
        ...
        <div className="pt-10 border-t border-gray-900 dark:border-gray-800 text-center text-gray-500 text-sm font-light">
          <p>
            © {new Date().getFullYear()} {CONTACT_INFO.company.name} - Todos os direitos reservados.
            Desenvolvido com foco em resultados.
          </p>
        </div>
      </div>
    </footer>
