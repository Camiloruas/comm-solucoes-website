...
const App: React.FC = () => {
  return (
    <div className="relative dark:bg-black transition-colors duration-300">
      <Navbar />
      ...
      {/* Final CTA */}
      <section className="py-24 bg-white dark:bg-gray-900 px-6 transition-colors duration-300">
